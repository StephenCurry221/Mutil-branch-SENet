...
def parseArgs():
    ...
    parse.add_argument('--logPth', type=str, default='./Ablation_hv_seg/log')
    ...
    parse.add_argument('--tensorboardPth', type=str, default='./Ablation_hv_seg/tensorboard')
    parse.add_argument('--modelPth', type=str, default='./Ablation_hv_seg/model_cls')
...
def main(args, logger):
    ...
    for epoch in range(args.epoch):
        ...
        for img, mask in trainLoader:
            ...
            loss4 = criterionMSE(branchse, mask.long().squeeze())
